...
class Detect2Node(Node): # MODIFY NAME
    def __init__(self):
        super().__init__("detect2") # MODIFY NAME
        self.pubx = self.create_publisher(Float32, 'cam2/dist/x', 10)
